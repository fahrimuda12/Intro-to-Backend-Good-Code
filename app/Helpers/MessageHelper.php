...
class MessageHelper
{
    ...
    public static function successLogin($keyword)
    {
        return "Pengguna $keyword berhasil login!";
    }

    public static function successJoin($keyword)
    {
        return "Pengguna $keyword berhasil join member!";
    }

    public static function errorAlreadyJoined($keyword)
    {
        return "Pengguna sudah join member $keyword!";
    }
    ...
    {
        return "Silakan melakukan autentikasi terlebih dahulu!";
    }
